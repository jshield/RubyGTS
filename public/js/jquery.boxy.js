...
Boxy.prototype = {
    ...
    moveToX: function(x) {
        if (typeof x == 'number') {
          ...
          else this.boxy.css({left: Boxy.DEFAULT_X}); // keeps the modal from moving off-screen
        }
        else this.centerX();
        return this;
    },
    ...
    moveToY: function(y) {
        if (typeof y == 'number') {
          ...
          else this.boxy.css({top: Boxy.DEFAULT_Y}); // keeps the modal from moving off-screen
        }
        else this.centerY();
        return this;
    },
